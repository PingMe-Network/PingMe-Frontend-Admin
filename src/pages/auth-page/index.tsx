...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen flex">
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 xl:px-20 text-primary-foreground">
          ...
          <div className="space-y-5">
            <div className="flex items-center gap-4">
              <div className="w-11 h-11 bg-primary-foreground/15 backdrop-blur-sm rounded-lg flex items-center justify-center">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-8 lg:p-12 bg-secondary/50">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden flex items-center gap-3 mb-10">
            ...
            <div>
              <h1 className="text-xl font-bold text-foreground">PingMe</h1>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-11 h-12 bg-background border-input focus:border-primary focus:ring-primary"
                    required
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-11 pr-11 h-12 bg-background border-input focus:border-primary focus:ring-primary"
                    required
                  />
                  <button
                    type="button"
