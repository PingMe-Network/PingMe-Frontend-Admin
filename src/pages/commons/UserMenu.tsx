  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          variant="ghost"
          className="group flex h-auto items-center gap-3 px-3 py-2 transition-colors hover:bg-blue-50"
        >
          <div className="flex items-center gap-3">
            <Avatar className="h-9 w-9 ring-2 ring-blue-100 transition-all group-hover:ring-blue-200">
              <AvatarImage
                src={
      ...
      >
        {/* User Info Header */}
        <div className="mb-2 flex items-center gap-3 rounded-lg bg-linear-to-r from-blue-50 to-purple-100 p-3">
